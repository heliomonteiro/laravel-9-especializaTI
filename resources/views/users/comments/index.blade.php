...
<table class="min-w-full leading-normal shadow-md rounded-lg overflow-hidden">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><a href="{{ route('comments.edit', ['user'=>$user->id,'id'=>$comment->id]) }}" class="bg-green-200 rounded-full py-2 px-6">Editar</a></td>
        </tr>
        @endforeach
    </tbody>
</table>
